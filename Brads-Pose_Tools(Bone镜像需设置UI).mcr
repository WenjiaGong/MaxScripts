...
rollout PoseToolsRO "Copy/Paste Transforms" width:188 height:321
(
	subrollout PoseSubRO "Pose Tools" width:180 height:313 pos:[4,4]
	on PoseToolsRO close do bufferTM = #()
)

rollout copyPaste "Copy/Paste"
(
	button copyPose "Copy Pose" width:buttonW height:buttonH
	button pastePose "Paste Pose" width:buttonW height:buttonH offset:[1,0] tooltip:"Note: Pasting is based on order of selection" enabled:false
...
rollout pasteOptions "Paste Options" width:400
(
	checkbox affectPos "Affect position" checked:true align:#left enabled:false
	radiobuttons posOptions labels:#("normal", "flipped") align:#right enabled:false
	checkbox affectRot "Affect rotation" checked:true enabled:false
	radiobuttons rotOptions labels:#("normal", "flipped") align:#right enabled:false
	group "Flip around:"
	(
		checkbox flipWorld "World" align:#left offset:[0,0] checked:true enabled:false
		pickbutton flipObj "Pick object" width:90 offset:[28,-24] enabled:false autodisplay:true
		label AxisLabel "Flip axis:" align:#left offset:[15,2]
		radiobuttons flipAxisRadio labels:#("X","Y","Z") columns:3 align:#left offset:[59,-18] default:1 enabled:false
		checkbox upAxisCheck "Ref axis:" align:#left offset:[-5,2] enabled:false
